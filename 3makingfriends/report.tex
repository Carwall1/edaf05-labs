...
\begin{document}
  ...
  The script confirmed that all solutions were correct. 
  ...
  For the core data structure, I used a DSU or Union-Find. This was implemented using two simple, flat arrays: a parent array to track the root representative of each friend group, and a rank array to keep track of the tree depths. 
  ...
  The overall time complexity is O(M log M) due to sorting the DSU is essentially O(1) for each union and find 